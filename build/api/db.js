...
const dbProductInfoConfig = __importStar(require("./db-cfg/db-producter-config.json"));
const dbPostgresConfig = __importStar(require("./db-cfg/db-postgres-config.json"));
